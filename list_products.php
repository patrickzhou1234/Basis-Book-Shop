...
<head>
   ...
   <style>.swal2-popup { font-size: calc(1vmin + 0.5vmax); }
   .condition-options {
         display: flex;
...
<section class="add-products">
   ...
   <form method="post" enctype="multipart/form-data">
      ...
      <div id="commonFields">
         <input type="text" name="title" class="box" placeholder="Enter product title" list="bookTitles">
         ...
         <input type="text" name="contact" class="box" placeholder="Enter contact info (email/number)">
